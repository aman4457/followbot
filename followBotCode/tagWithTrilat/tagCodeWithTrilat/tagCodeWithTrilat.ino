...
float anchor_matrix[N_ANCHORS][3] = { //list of anchor coordinates, relative to chosen origin.
  {-14.0, 0.0, 0.0},  //Anchor labeled #1
  {14, 0.0, 0.0},//Anchor labeled #2
  {0.0, 20.0, 0.0}, //Anchor labeled #3
...
void newRange()
{
  ...
  if (true) { //three measurements TODO: check millis() wrap
    ...
    Serial.print(", RMSE might be bad ?");
